...
def main():
   ...
   for i in range(10):
      ...
      if(com_finger == 1):
         if(my_finger == 1):
            print("컴퓨터가 낸 것은 가위입니다. -----> 비겼네요ㅋ")
         elif(my_finger == 2):
            print("컴퓨터가 낸 것은 가위입니다. -----> 사용자 승리!")
         elif(my_finger == 3):
            print("컴퓨터가 낸 것은 가위입니다. -----> 컴퓨터 승리!")
      
      elif(com_finger == 2):
         if(my_finger == 1):
            print("컴퓨터가 낸 것은 바위입니다. -----> 컴퓨터 승리!")
         elif(my_finger == 2):
            print("컴퓨터가 낸 것은 가위입니다. -----> 비겼네요ㅋ")
         elif(my_finger == 3):
            print("컴퓨터가 낸 것은 가위입니다. -----> 사용자 승리!")
